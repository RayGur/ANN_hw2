...
class Metrics:
    ...
    def precision_recall_f1(y_true, y_pred, average='macro', zero_division=0):
        ...
        if average is None:
            ...
            # 二分類: 只返回正類 (假設正類是 1)
            if num_classes != 2:
                raise ValueError("'binary' average only works for binary classification")
...
if __name__ == "__main__":
    ...
    # 宏平均
    print("\nMacro average:")
    p_macro, r_macro, f1_macro = Metrics.precision_recall_f1(y_true, y_pred, average='macro')
    print(f"  Precision={p_macro:.3f}, Recall={r_macro:.3f}, F1={f1_macro:.3f}")
    
    # 微平均
    print("\nMicro average:")
    p_micro, r_micro, f1_micro = Metrics.precision_recall_f1(y_true, y_pred, average='micro')
    ...
    p, r, f1 = Metrics.precision_recall_f1(y_true_binary, y_pred_binary, average='binary')
